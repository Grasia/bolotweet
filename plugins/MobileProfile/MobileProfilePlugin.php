...
define('PAGE_TYPE_PREFS_MOBILEPROFILE', 'application/vnd.wap.xhtml+xml, application/xhtml+xml, text/html;q=0.9');
...
class MobileProfilePlugin extends WAP20Plugin {
    ...
    function _common_path($relative, $ssl = false) {
        ...
        if (($ssl && (common_config('site', 'ssl') === 'sometimes')) || common_config('site', 'ssl') === 'always') {
            $proto = 'https';
